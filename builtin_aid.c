...
/**
 * aid_all - Displays all possible builtinc
 *	ommands with one command same as --help or man
 */
void aid_all(void)
{
...
/**
 * aid_alias - Displays information on the
...
/**
 * aid_cd - Displays information on the
 *	builtin command 'cd'
 */
void aid_cd(void)
{
...
/**
 * aid_exit - Displays information on the
...
/**
 * aid_help - Displays information on the
 *	builtin command 'help' an advanced man command
 */
void aid_help(void)
{
